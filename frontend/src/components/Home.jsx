...
function Home() {
    ...
    useEffect(() => {
        const fetchtodos = async () => {
            try {
                ...
                const response = await axios.get("http://a4972ebfdc56d4c2cb649dd756d8baa2-625468555.ap-south-1.elb.amazonaws.com:4001/todo/fetch", {
    ...
    const todoCreate = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                "http://a4972ebfdc56d4c2cb649dd756d8baa2-625468555.ap-south-1.elb.amazonaws.com:4001/todo/create",
                {
                    text: newTodo,
                    completed: false,
                },
    ...
    const todoStatus = async (id) => {
        ...
        try {
            ...
            const response = await axios.put(
                `http://a4972ebfdc56d4c2cb649dd756d8baa2-625468555.ap-south-1.elb.amazonaws.com:4001/todo/update/${id}`,
                {
                    ...todo,
    ...
    const todoDelete = async (id) => {
        try {
            const token = localStorage.getItem("jwt");
            await axios.delete(`http://a4972ebfdc56d4c2cb649dd756d8baa2-625468555.ap-south-1.elb.amazonaws.com:4001/todo/delete/${id}`, {
                withCredentials: true,
                headers: {
                    "Authorization": `Bearer ${token}`,
                },
    ...
    const logout = async () => {
        try {
            const token = localStorage.getItem("jwt");
            await axios.get("http://a4972ebfdc56d4c2cb649dd756d8baa2-625468555.ap-south-1.elb.amazonaws.com:4001/user/logout", {
                withCredentials: true,
                headers: {
                    "Authorization": `Bearer ${token}`,
                },
